...
/* This needs to be here until the window status stuff is rewritten */
...
void nds_print_glyph(winid win, XCHAR_P x, XCHAR_P y, int glyph, int bkglyph)
{
  nds_nhwindow_t *window = windows[win];
...
void nds_outrip(winid win, int how, time_t when)
{
